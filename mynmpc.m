function [t, x, u, optobj] = mynmpc(runningcosts, terminalcosts, ...
...
% (C) Lars Gruene, Juergen Pannek 2011
    ...
    mpciter = 0;
    message = sprintf('NMPC: %%g/%g iterations, fbest = %%20.20g.\n',mpciterations);
    ...
    while(mpciter < mpciterations)
        ...
        mpciter = mpciter+1;
        optobj.iteration(mpciter) = mpciter;
        optobj.objvalue(mpciter) = V_current;      
        fprintf(message,mpciter,V_current);   
...
function [x, t_intermediate, x_intermediate, varargout] = dynamic(system, T, t0, ...
